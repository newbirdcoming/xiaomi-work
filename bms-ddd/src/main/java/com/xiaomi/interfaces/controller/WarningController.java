...
public class WarningController {
    private final SignalApplicationService signalService;
    private final WarningService warningService;


    @PostMapping("/warning")
    public ResponseResult<List<WarningService.WarningResult>> processWarnings(
            @RequestBody List<WarningRequest> requests) {
